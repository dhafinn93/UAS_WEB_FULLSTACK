...
<section class="hero">
    <div class="container text-center">
        ...
        <form class="row justify-content-center mt-4">
            <div class="col-md-5">
                <input type="text" class="form-control form-control-lg" placeholder="Cari nama kos...">
            </div>
            ...
            @forelse($kos as $item)
                <div class="col-md-4 mb-4">
                    <div class="card card-kos h-100"> 
                        ...
                        @if($item->foto)
                            <img src="{{ asset('storage/' . $item->foto) }}" class="card-img-top" style="height: 230px; object-fit: cover;" alt="Foto {{ $item->nama }}">
                        @else
                        ...
                        <div class="card-body d-flex flex-column"> 
                            ...
                            <a href="/kos/{{ $item->id }}" class="btn btn-primary w-100">Lihat Detail</a>
                        </div>
